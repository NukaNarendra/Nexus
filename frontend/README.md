...
This frontend provides the admin dashboard experience for Nexus. It is a React + Vite application with Tailwind styling that talks to the Express and MongoDB backend for all CRUD workflows.
