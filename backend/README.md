...
This backend powers the Nexus admin dashboard with a REST API for managing users, products, and orders. It is built with Express and Mongoose and connects to MongoDB through environment-based configuration.
